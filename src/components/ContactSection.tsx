export default function ContactSection() {
    return (
        <section id="kontak" className="section-pad" style={{ backgroundColor: "#faf8f4" }}>
            <div className="max-w-6xl mx-auto px-5 md:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 md:gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <address className="not-italic text-sm leading-relaxed" style={{ color: "#1e1a16" }}>
                                    Landungsari, Kec. Dau<br />
                                    Kabupaten Malang<br />
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs mt-1" style={{ color: "#7c6c5a" }}>
                    ...
                    <div className="lg:col-span-3">
                        <div
                            className="w-full overflow-hidden shadow-card"
                            style={{ height: "384px", border: "1px solid #e2d9cc" }}
                        >
                            <iframe
                              src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d240.58013501206975!2d112.58967926383856!3d-7.930020598645039!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sid!2sid!4v1772379998678!5m2!1sid!2sid"
                                ...
                                title="Lokasi Mimilcorner di Landungsari, Malang"
                            />
                        </div>
                    </div>
                </div>
